...
**Created:** 2026-05-15  
**Last updated:** 2026-07-08 (M9-023 done: _run_home() now force-refreshes device_state, matching _run_safe_stop()'s pattern — mount-strip no longer lags behind the phase panel after HOME confirmation)
