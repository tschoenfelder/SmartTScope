...
**Created:** 2026-05-15  
**Last updated:** 2026-07-08 (M9-022 corrected twice: reverted the auto-set-park-position regression, then removed the explicit "Set Park Position" UI too — not a formally requested capability yet; the gap stays open on purpose)
